...
Create a base class Vehicle. It should contain the following members:
    ...
     A public constructor which accepts (fuel, horsePower) and set the default fuel consumption on the field
fuelConsumption
     void drive(double kilometers)
        o The drive method should have the functionality to reduce the fuel based on the traveled
...
The default fuel consumption for Vehicle is 1.25. Some the classes have different default fuel consumption:
